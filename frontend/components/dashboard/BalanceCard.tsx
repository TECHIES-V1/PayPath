...
export default function BalanceCard() {
  ...
  const animatedBalance = useCountUp(mockData.balance);
    ...
    <div className="relative overflow-hidden rounded-3xl bg-[oklch(0.15_0.005_0)] text-white p-6 md:p-8">
      ...
      <div className="relative z-10">
        ...
        <div className="flex gap-2">
          <button className="flex items-center gap-1.5 bg-white/[0.08] hover:bg-white/[0.12] text-white rounded-full px-4 py-2 text-xs font-medium transition-colors">
